...
| `shipment-detail.md` | Individual shipment workspace: header, documents, team, process box, workflow steps, customer link. | Partial. | `/shipments/:id` exists and secure customer access controls were preserved. Canonical step/team data model differs from the plan. |
