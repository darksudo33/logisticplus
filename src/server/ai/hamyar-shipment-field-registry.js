...
export const HAMYAR_SHIPMENT_FIELD_DEFINITIONS = deepFreeze([
  ...
  field({
    ...
    labelFa: "تعداد کالا",
    labelEn: "goods count",
    aliases: ["چند تا کالا", "چند کالا", "تعداد کالاها", "goods count", "items count"],
  ...
  field({
    ...
    labelFa: "وجود کالا",
    labelEn: "goods exist",
    aliases: ["کالا داره", "کالایی ثبت شده", "آیا کالایی ثبت شده", "has goods", "goods exist"],
  ...
  field({
    ...
    aliases: ["مرحله فعلی بار", "مرحله فعلی محموله", "current stage"],
  ...
  field({
    ...
    aliases: ["آخرین بار کی آپدیت شده", "آخرین بار کی به روز شده", "کی آپدیت شده", "تاریخ آپدیت", "updated at", "last update"],
  ...
  field({
    ...
    labelEn: "updated by",
    aliases: ["کی آپدیتش کرده", "چه کسی به روز کرده", "توسط چه کسی به‌روزرسانی شده", "updated by"],
  ...
  field({
    ...
    aliases: ["کانتینر 20 فوت", "۲۰ فوت", "20ft", "20 foot container"],
  ...
  field({
    ...
    aliases: ["کانتینر 40 فوت", "۴۰ فوت", "40ft", "40 foot container"],
  ...
  field({
    ...
    labelFa: "لیست کالاها",
    labelEn: "goods list",
    aliases: ["فهرست کالا", "لیست کالا", "کالاهای بار", "goods list", "commodities"],
  ...
  field({
    ...
    aliases: ["اسنادش", "مدارکش", "تعداد سند", "تعداد اسناد", "تعداد مدارک", "چند تا سند داره", "documents count", "document count"],
    relationPath: ["shipment", "documents", "count"],
    sourcePath: "documents count by shipment_id",
    answerPolicy: HAMYAR_SHIPMENT_FIELD_POLICY.COUNT,
    metadataOnly: true,
  ...
  field({
    ...
    aliases: ["سند داره", "سندی داره", "سندی بارگذاری شده", "مدرک داره", "آیا سندی بارگذاری شده", "has document", "has documents", "documents exist"],
  ...
  field({
    ...
    aliases: ["پیام داخلی دارد", "پیام داخلی داره", "چت داخلی دارد", "گفتگو داخلی دارد", "internal messages"],
  ...
  field({
    ...
    aliases: ["تعداد پیام داخلی", "چند تا پیام داخلی", "تعداد چت داخلی", "message count", "internal message count"],
  ...
  field({
    ...
    aliases: ["تاریخ کوتاژ", "تاریخ ثبت کوتاج", "cotage date", "cotage registration date"],
  ...
  field({
    ...
    aliases: ["مبلغ نهایی پرداختی", "پرداختی نهایی", "final paid amount"],
  ...
  field({
    ...
    aliases: ["مجوز دارد", "مجوز داره", "آیا مجوزی ثبت شده", "has permit", "permits exist"],
  ...
  field({
    ...
    aliases: ["چند تا مجوز", "لیست مجوزها", "مجوزها", "permit count", "permits list"],
  ...
  field({
    ...
    aliases: ["مبلغ گمرکی", "هزینه گمرکی", "customs amount"],
  ...
  field({
    ...
    aliases: ["تفاوت گمرکی", "مابه التفاوت گمرکی", "customs difference"],
  ...
  field({
    ...
    labelEn: "customs tax",
    aliases: ["مالیات گمرکی", "وضعیت مالیات گمرکی", "customs tax"],
  ...
  field({
    ...
    labelFa: "کد شعبه",
    labelEn: "branch code",
    aliases: ["کد شعبه بانک", "branch code"],
  ...
  field({
    ...
    aliases: ["کد ابزار پرداخت", "کد ابزار", "payment instrument code"],
  ...
  field({
    ...
    labelEn: "notes exist",
    aliases: ["یادداشت دارد", "یادداشت داره", "نوت دارد", "notes exist", "has note"],
