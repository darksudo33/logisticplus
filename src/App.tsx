  ...
  return (
    <Suspense fallback={routeFallback}>
      <Routes>
        ...
        <Route path="/customers" element={<ProtectedAppLayout anyOf={["customers.view"]}><Customers /></ProtectedAppLayout>} />
        <Route path="/customers/:id" element={<ProtectedAppLayout anyOf={["customers.view"]}><CustomerDetail /></ProtectedAppLayout>} />
